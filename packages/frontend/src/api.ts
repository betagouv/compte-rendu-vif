...
import { Database, Service } from "./db/AppSchema";
...
export const unauthenticatedApi = createApiClientWithUrl(ENV.VITE_BACKEND_URL, { ignoreToken: true });
...
export type AuthUser = Prettify<RouterOutputs<"/api/authenticate">["user"]>;

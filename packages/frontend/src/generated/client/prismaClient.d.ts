...
export type Report_to_clausePayload<
  ExtArgs extends $Extensions.Args = $Extensions.DefaultArgs,
> = {
...
export type Report_to_clause =
  runtime.Types.DefaultSelection<Report_to_clausePayload>;
...
> {
   ...
   * ```
   */
  get report_to_clause(): Prisma.Report_to_clauseDelegate<
    GlobalReject,
    ExtArgs
  >;
}
...
export namespace Prisma {
  ...
  */
      ...
      Report_to_clause: {
        ...
        operations: {
          ...
          count: {
            ...
            result:
              | $Utils.Optional<Report_to_clauseCountAggregateOutputType>
              | number;
          };
        };
      };
  ...
  type GetClauseGroupByPayload<T extends ClauseGroupByArgs> =
  ...
  type ClauseGetPayload<S extends boolean | null | undefined | ClauseArgs> =
    $Types.GetResult<ClausePayload, S>;

  type ClauseCountArgs<
    ExtArgs extends $Extensions.Args = $Extensions.DefaultArgs,
  ...
  > {
    ...
    >(
      ...
      "Clause"
    > extends True
      ? Prisma__ClauseClient<
          $Types.GetResult<ClausePayload<ExtArgs>, T, "findUnique", never>,
          never,
          ExtArgs
        >
      : Prisma__ClauseClient<
          $Types.GetResult<
            ClausePayload<ExtArgs>,
            T,
            "findUnique",
            never
          > | null,
    ...
    findUniqueOrThrow<T extends ClauseFindUniqueOrThrowArgs<ExtArgs>>(
      ...
      $Types.GetResult<ClausePayload<ExtArgs>, T, "findUniqueOrThrow", never>,
      never,
      ExtArgs
    >;
    ...
    > extends True
      ? Prisma__ClauseClient<
          $Types.GetResult<ClausePayload<ExtArgs>, T, "findFirst", never>,
          never,
          ExtArgs
        >
      : Prisma__ClauseClient<
    ...
    findFirstOrThrow<T extends ClauseFindFirstOrThrowArgs<ExtArgs>>(
      ...
      $Types.GetResult<ClausePayload<ExtArgs>, T, "findFirstOrThrow", never>,
      never,
      ExtArgs
    >;
    ...
    findMany<T extends ClauseFindManyArgs<ExtArgs>>(
      ...
      $Types.GetResult<ClausePayload<ExtArgs>, T, "findMany", never>
    >;
    ...
    create<T extends ClauseCreateArgs<ExtArgs>>(
      ...
      $Types.GetResult<ClausePayload<ExtArgs>, T, "create", never>,
      never,
      ExtArgs
    >;
    ...
    delete<T extends ClauseDeleteArgs<ExtArgs>>(
      ...
      $Types.GetResult<ClausePayload<ExtArgs>, T, "delete", never>,
      never,
      ExtArgs
    >;
    ...
    update<T extends ClauseUpdateArgs<ExtArgs>>(
      ...
      $Types.GetResult<ClausePayload<ExtArgs>, T, "update", never>,
      never,
      ExtArgs
    >;
    ...
    upsert<T extends ClauseUpsertArgs<ExtArgs>>(
      ...
      $Types.GetResult<ClausePayload<ExtArgs>, T, "upsert", never>,
      never,
      ExtArgs
    >;
   ...
   */
  export class Prisma__ClauseClient<
    T,
    Null = never,
    ExtArgs extends $Extensions.Args = $Extensions.DefaultArgs,
  > implements Prisma.PrismaPromise<T>
  {
    ...
    report_to_clause<T extends Clause$report_to_clauseArgs<ExtArgs> = {}>(
      ...
      | $Types.GetResult<Report_to_clausePayload<ExtArgs>, T, "findMany", never>
      | Null
    >;
   ...
   * Clause findUnique
   */
  export interface ClauseFindUniqueArgs<
    ExtArgs extends $Extensions.Args = $Extensions.DefaultArgs,
  ...
  type ReportGetPayload<S extends boolean | null | undefined | ReportArgs> =
    $Types.GetResult<ReportPayload, S>;
  ...
  > {
    ...
    > extends True
      ? Prisma__ReportClient<
          $Types.GetResult<ReportPayload<ExtArgs>, T, "findUnique", never>,
          never,
          ExtArgs
        >
      : Prisma__ReportClient<
          $Types.GetResult<
            ReportPayload<ExtArgs>,
            T,
            "findUnique",
            never
          > | null,
    ...
    findUniqueOrThrow<T extends ReportFindUniqueOrThrowArgs<ExtArgs>>(
      ...
      $Types.GetResult<ReportPayload<ExtArgs>, T, "findUniqueOrThrow", never>,
      never,
      ExtArgs
    >;
    ...
    > extends True
      ? Prisma__ReportClient<
          $Types.GetResult<ReportPayload<ExtArgs>, T, "findFirst", never>,
          never,
          ExtArgs
        >
      : Prisma__ReportClient<
    ...
    findFirstOrThrow<T extends ReportFindFirstOrThrowArgs<ExtArgs>>(
      ...
      $Types.GetResult<ReportPayload<ExtArgs>, T, "findFirstOrThrow", never>,
      never,
      ExtArgs
    >;
    ...
    findMany<T extends ReportFindManyArgs<ExtArgs>>(
      ...
      $Types.GetResult<ReportPayload<ExtArgs>, T, "findMany", never>
    >;
    ...
    create<T extends ReportCreateArgs<ExtArgs>>(
      ...
      $Types.GetResult<ReportPayload<ExtArgs>, T, "create", never>,
      never,
      ExtArgs
    >;
    ...
    delete<T extends ReportDeleteArgs<ExtArgs>>(
      ...
      $Types.GetResult<ReportPayload<ExtArgs>, T, "delete", never>,
      never,
      ExtArgs
    >;
    ...
    update<T extends ReportUpdateArgs<ExtArgs>>(
      ...
      $Types.GetResult<ReportPayload<ExtArgs>, T, "update", never>,
      never,
      ExtArgs
    >;
    ...
    upsert<T extends ReportUpsertArgs<ExtArgs>>(
      ...
      $Types.GetResult<ReportPayload<ExtArgs>, T, "upsert", never>,
      never,
      ExtArgs
    >;
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__ReportClient<
    T,
    Null = never,
    ExtArgs extends $Extensions.Args = $Extensions.DefaultArgs,
  > implements Prisma.PrismaPromise<T>
   ...
   * Report findUnique
   */
  export interface ReportFindUniqueArgs<
    ExtArgs extends $Extensions.Args = $Extensions.DefaultArgs,
   ...
   * Report findFirst
   */
  export interface ReportFindFirstArgs<
    ExtArgs extends $Extensions.Args = $Extensions.DefaultArgs,
  ...
  export type GetReport_to_clauseAggregateType<
    T extends Report_to_clauseAggregateArgs,
  > = {
    [P in keyof T & keyof AggregateReport_to_clause]: P extends
      | "_count"
      | "count"
      ? T[P] extends true
        ? number
  ...
  type GetReport_to_clauseGroupByPayload<
    T extends Report_to_clauseGroupByArgs,
  > = Prisma.PrismaPromise<
    Array<
      PickArray<Report_to_clauseGroupByOutputType, T["by"]> & {
        [P in keyof T &
          keyof Report_to_clauseGroupByOutputType]: P extends "_count"
          ? T[P] extends boolean
            ? number
  ...
  type Report_to_clauseGetPayload<
    S extends boolean | null | undefined | Report_to_clauseArgs,
  > = $Types.GetResult<Report_to_clausePayload, S>;

  type Report_to_clauseCountArgs<
    ExtArgs extends $Extensions.Args = $Extensions.DefaultArgs,
  ...
  > {
    [K: symbol]: {
      types: Prisma.TypeMap<ExtArgs>["model"]["Report_to_clause"];
      meta: { name: "Report_to_clause" };
    };
    /**
    ...
    > extends True
      ? Prisma__Report_to_clauseClient<
          $Types.GetResult<
            Report_to_clausePayload<ExtArgs>,
            T,
            "findUnique",
            never
          >,
    ...
    >(
      args: SubsetIntersection<T, Report_to_clauseGroupByArgs, OrderByArg> &
        InputErrors,
    ): {} extends InputErrors
      ? GetReport_to_clauseGroupByPayload<T>
      : Prisma.PrismaPromise<InputErrors>;
  }
  ...
  > implements Prisma.PrismaPromise<T>
  {
    ...
    clause<T extends ClauseArgs<ExtArgs> = {}>(
      ...
      $Types.GetResult<ClausePayload<ExtArgs>, T, "findUnique", never> | Null,
      never,
      ExtArgs
    >;
    ...
    report<T extends ReportArgs<ExtArgs> = {}>(
      ...
      $Types.GetResult<ReportPayload<ExtArgs>, T, "findUnique", never> | Null,
      never,
      ExtArgs
    >;
   ...
   */
  export interface Report_to_clauseFindUniqueArgs<
    ExtArgs extends $Extensions.Args = $Extensions.DefaultArgs,
   ...
   */
  export interface Report_to_clauseFindFirstArgs<
    ExtArgs extends $Extensions.Args = $Extensions.DefaultArgs,
  ...
  > = {
     ...
     */
    data: XOR<
      Report_to_clauseCreateInput,
      Report_to_clauseUncheckedCreateInput
    >;
  };
  ...
  > = {
     ...
     */
    data: XOR<
      Report_to_clauseUpdateInput,
      Report_to_clauseUncheckedUpdateInput
    >;
    /**
  ...
  > = {
     ...
     */
    data: XOR<
      Report_to_clauseUpdateManyMutationInput,
      Report_to_clauseUncheckedUpdateManyInput
    >;
    /**
  ...
  export type ClauseScalarFieldEnum =
    (typeof ClauseScalarFieldEnum)[keyof typeof ClauseScalarFieldEnum];
  ...
  export type ClauseCreateNestedOneWithoutReport_to_clauseInput = {
    create?: XOR<
      ClauseCreateWithoutReport_to_clauseInput,
      ClauseUncheckedCreateWithoutReport_to_clauseInput
    >;
  ...
  export type ReportCreateNestedOneWithoutReport_to_clauseInput = {
    create?: XOR<
      ReportCreateWithoutReport_to_clauseInput,
      ReportUncheckedCreateWithoutReport_to_clauseInput
    >;
  ...
  export type ClauseUpdateOneRequiredWithoutReport_to_clauseNestedInput = {
    ...
    connect?: ClauseWhereUniqueInput;
    update?: XOR<
      ClauseUpdateWithoutReport_to_clauseInput,
      ClauseUncheckedUpdateWithoutReport_to_clauseInput
    >;
  };
  ...
  export type ReportUpdateOneRequiredWithoutReport_to_clauseNestedInput = {
    ...
    connect?: ReportWhereUniqueInput;
    update?: XOR<
      ReportUpdateWithoutReport_to_clauseInput,
      ReportUncheckedUpdateWithoutReport_to_clauseInput
    >;
  };
  ...
  export type Report_to_clauseCreateOrConnectWithoutClauseInput = {
    where: Report_to_clauseWhereUniqueInput;
    create: XOR<
      Report_to_clauseCreateWithoutClauseInput,
      Report_to_clauseUncheckedCreateWithoutClauseInput
    >;
  };
  ...
  export type Report_to_clauseUpsertWithWhereUniqueWithoutClauseInput = {
    where: Report_to_clauseWhereUniqueInput;
    update: XOR<
      Report_to_clauseUpdateWithoutClauseInput,
      Report_to_clauseUncheckedUpdateWithoutClauseInput
    >;
    create: XOR<
      Report_to_clauseCreateWithoutClauseInput,
      Report_to_clauseUncheckedCreateWithoutClauseInput
  ...
  export type Report_to_clauseUpdateManyWithWhereWithoutClauseInput = {
    ...
    data: XOR<
      Report_to_clauseUpdateManyMutationInput,
      Report_to_clauseUncheckedUpdateManyWithoutReport_to_clauseInput
    >;
  };
  ...
  export type Report_to_clauseCreateOrConnectWithoutReportInput = {
    where: Report_to_clauseWhereUniqueInput;
    create: XOR<
      Report_to_clauseCreateWithoutReportInput,
      Report_to_clauseUncheckedCreateWithoutReportInput
    >;
  };
  ...
  export type Report_to_clauseUpsertWithWhereUniqueWithoutReportInput = {
    where: Report_to_clauseWhereUniqueInput;
    update: XOR<
      Report_to_clauseUpdateWithoutReportInput,
      Report_to_clauseUncheckedUpdateWithoutReportInput
    >;
    create: XOR<
      Report_to_clauseCreateWithoutReportInput,
      Report_to_clauseUncheckedCreateWithoutReportInput
